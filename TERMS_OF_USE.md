...
**Note**: iCloud sync and its controls (sync toggle, sync status, last synced timestamp) are available to all users. Your data syncs to your private iCloud container regardless of subscription tier.
...
*These terms were last audited against the FieldPad codebase on 2026-02-14.*
